...
- **一键摸鱼计时器**：开启后实时结算本次摸鱼的秒级带薪收益，可设定每日摸鱼上限并可视化饱满度。
- **滑水荣誉成就墙**：8 种摸鱼成就（初次开溜、忙里偷闲、终极摸鱼王…），解锁记录永久保存在本地。
- **本周摸鱼数据图**：柱状图追踪一周摸鱼时长趋势，标注超额天数。
- **午餐拯救决定器**：不知道吃什么？内置生存助理，一键随机决定，还能自建专属饭堂候选池，告别选择困难。
